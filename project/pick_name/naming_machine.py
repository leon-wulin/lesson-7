...
def pick_family_name():
    family_names = random.choice(family_names)
...
def pick_full_name_by_sex(is_boy):
    sf = pick_family_name()

    sg = pick_given_name_by_sex()

    full_name_by_sex = sf + sg


return full_name_by_sex
